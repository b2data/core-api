...
const DeliveryIdtStatusEnum _$deliveryIdtStatusEnum_list =
    const DeliveryIdtStatusEnum._('list');
...
DeliveryIdtStatusEnum _$deliveryIdtStatusEnumValueOf(String name) {
  switch (name) {
    ...
    case 'list':
      return _$deliveryIdtStatusEnum_list;
    case 'destroyed':
